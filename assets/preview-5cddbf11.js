import{w as A,l as C}from"./es.object.get-own-property-descriptor-d5205e32.js";import"./web.url.constructor-d96bbe9c.js";import{d as E,f as h,u as _,b as T}from"./iframe-58e2e79f.js";import"./es.number.is-integer-907cc319.js";var y="backgrounds",M;function L(o,r){return r||(r=o.slice(0)),Object.freeze(Object.defineProperties(o,{raw:{value:Object.freeze(r)}}))}var s=A.document,I=A.window,P=function(){var r=I.matchMedia("(prefers-reduced-motion: reduce)");return r.matches},R=function(r){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:[],a=arguments.length>2?arguments[2]:void 0;if(r==="transparent")return"transparent";if(e.find(function(t){return t.value===r}))return r;var n=e.find(function(t){return t.name===a});if(n)return n.value;if(a){var d=e.map(function(t){return t.name}).join(", ");C.warn(E(M||(M=L([`
    ...
    `)},[i,v]);return _(function(){var f=e.viewMode==="docs"?"addon-backgrounds-docs-".concat(e.id):"addon-backgrounds-color";if(!u){O(f);return}N(f,g,e.viewMode==="docs"?e.id:null)},[u,g,e]),r()},z;function D(o,r){return r||(r=o.slice(0)),Object.freeze(Object.defineProperties(o,{raw:{value:Object.freeze(r)}}))}var F=T(function(){},E(z||(z=D([`
    Backgrounds Addon: The cell size parameter has been changed.

    - parameters.grid.cellSize should now be parameters.backgrounds.grid.cellSize
    See https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#deprecated-grid-parameter
  `])))),K=function(r,e){var a,n,d,t,l=e.globals,i=e.parameters,u=i[y].grid,v=((a=l[y])===null||a===void 0?void 0:a.grid)===!0&&u.disable!==!0,g=u.cellAmount,f=u.cellSize,p=u.opacity,S=e.viewMode==="docs",c;(n=i.grid)!==null&&n!==void 0&&n.cellSize?(c=i.grid.cellSize,F()):c=f;var j=i.layout===void 0||i.layout==="padded",w=j?16:0,m=(d=u.offsetX)!==null&&d!==void 0?d:S?20:w,b=(t=u.offsetY)!==null&&t!==void 0?t:S?20:w,B=h(function(){var k=e.viewMode==="docs"?"#anchor--".concat(e.id," .docs-story"):".sb-show-main",x=["".concat(c*g,"px ").concat(c*g,"px"),"".concat(c*g,"px ").concat(c*g,"px"),"".concat(c,"px ").concat(c,"px"),"".concat(c,"px ").concat(c,"px")].join(", ");return`
      `.concat(k,` {
    ...
    `)},[c]);return _(function(){var k=e.viewMode==="docs"?"addon-backgrounds-grid-docs-".concat(e.id):"addon-backgrounds-grid";if(!v){O(k);return}H(k,B)},[v,B,e]),r()},q=[K,G],J={backgrounds:{grid:{cellSize:20,opacity:.5,cellAmount:5},values:[{name:"light",value:"#F8F8F8"},{name:"dark",value:"#333333"}]}};export{q as decorators,J as parameters};
//# sourceMappingURL=preview-5cddbf11.js.map
